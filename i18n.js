...
(function () {
  ...
  const EN = {
    ...
    "当前下单的人比较多，请 1 分钟后再试": "Too many orders right now - please try again in a minute",
    "这个商品正在被抢购，请稍后再试": "This item is being bought up fast - please try again shortly",
    "这个邮箱下单次数已到上限，请完成支付后再试": "This email hit its order limit - complete payment first",
